  ...
  >
    ...
    <div class="flex items-center px-4 -mx-2 mt-6">
      <img
        ...
        :src="!user.imageUrl ? 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png' : user.imageUrl"
        alt="avatar"
      />
      <div>
        <h4
      ...
      <nav>
        ...
        >
          <img
            ...
            alt=""
            class="contrast-0 brightness-50"
            width="22"
          />
          <!-- <svg
            class="w-5 h-5"
