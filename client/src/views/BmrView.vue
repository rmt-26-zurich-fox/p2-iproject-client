...
export default {
	...
	methods: {
		...mapActions(useFoodStore, ["bmrCalculator"]),
		bmrCount() {
			Swal.fire({
				title: "Loading",
				timer: 1500,
				...
				this.bmrCalculator(this.input);
			});
		},
	},
	computed: {
		...mapState(useFoodStore, ["bmr"]),
	},
};
</script>
<template>
									...
									<table class="w-full text-sm text-left text-gray-500">
										...
										<tbody>
											<tr class="bg-white border-b">
												...
												>
													<i class="fas fa-fire-alt"> - BMR</i>
												</th>
												<td class="py-4 px-6 text-black">{{ bmr.bmr }}</td>
											</tr>
											<tr class="bg-white border-b">
												<th
													scope="row"
													class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
												>
													<i class="fas fa-bread-slice"> - Carbs</i>
												</th>
												<td class="py-4 px-6 text-black">{{ bmr.carbs }} gr</td>
											</tr>
											<tr class="bg-white">
												<th
													scope="row"
													class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
												>
													<i class="fas fa-hamburger"> - Fat</i>
												</th>
												<td class="py-4 px-6 text-black">{{ bmr.fat }} gr</td>
											</tr>
											<tr class="bg-white">
												<th
													scope="row"
													class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap"
												>
													<i class="fas fa-drumstick-bite"> - Protein</i>
												</th>
