...
export default {
  ...
  mounted() {
    const cb = this.googleLogin
      google.accounts.id.initialize({
        client_id: "246852571418-40tjqljahamf5td2ep8u0heisvtceslf.apps.googleusercontent.com",
        callback: cb
      });
...
<section class="h-screen">
  <div class="container px-6 py-12 h-full ">
    <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
      <div class="md:w-8/12 lg:w-6/12 mb-12 md:mb-0 rounded-lg">
        <img
          src="https://freepikpsd.com/file/2019/10/anime-png-tumblr-1.png"
          class="w-full"
          alt="Phone image"
        />
      </div>
      <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
        <form @submit.prevent="postLogin">
          ...
          <button id="buttonDiv" class="m-auto w-full"></button>
          <a
