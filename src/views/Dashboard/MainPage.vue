<script>
	...
	import NightwavePage from "./NightwavePage.vue";
	import SortiePage from "./SortiePage.vue";
	import InvasionsPage from "./InvasionsPage.vue";
...
<template>
	<h1>NEED IMAGE???? https://cdn.warframestat.us/img/${item.imageName}</h1>
	<div class="">
