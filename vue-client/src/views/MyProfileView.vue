          ...
          <div class="card-form">
            ...
            <div class="card-form__inner first">
              <v-row justify="center">
                ...
                <v-col cols="12" class="text-center">
                  <v-text-field v-model="name" label="Full Name" variant="outlined" shaped disabled="true">
                  </v-text-field>
                </v-col>
                <v-col cols="12" class="text-center">
                  <v-text-field v-model="email" label="Email" variant="outlined" shaped disabled="true"></v-text-field>
                </v-col>
                <v-col cols="12" class="text-center">
                  <v-text-field v-model="phone" label="Phone Number" variant="outlined" shaped disabled="true">
                  </v-text-field>
                </v-col>
                <v-col cols="12" class="text-center">
                  <v-text-field v-model="date" label="Birthdate" variant="outlined" shaped disabled="true">
                  </v-text-field>
                </v-col>
              </v-row>
            </div>
                        ...
                        <transition name="slide-fade-up">
                          <div class="card-item__name" v-if="cardName.length" key="1">
                            <transition-group name="slide-fade-right">
                              <span class="card-item__nameItem" v-for="(n, $index) in cardName.replace(
                                /\s\s+/g,
                                ' '
            ...
            <div class="card-form__inner">
              <div class="card-input">
                ...
                <input type="text" id="cardNumber" class="card-input__input" v-model="cardNumber" @focus="focusInput"
                  @blur="blurInput" autocomplete="off" />
              </div>
              <div class="card-input">
