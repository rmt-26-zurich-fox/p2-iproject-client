      ...
      <ul class="menu">
        <li>
          <router-link href="#" to="/">
            ...
            <span style="margin-left: 1.3rem" id="food"
              >Laundry List</span
            ></router-link
          >
        </li>
        <li v-if="role == 'Admin'">
          <router-link to="/cloth" href="#">
            ...
            <span style="margin-left: 1.1rem">Add Laundry</span>
          </router-link>
        </li>
        <li @click.prevent="toLogin">
          <a href="#">
            <svg
              id="coba"
              class="speech-bubble"
            ...
            <span style="margin-left: 1.1rem"> Logout </span>
          </a>
        </li>
      </ul>
    </nav>
...
export default {
  data() {
    return {
      role: localStorage.getItem("access_token"),
    };
  },
  methods: {
