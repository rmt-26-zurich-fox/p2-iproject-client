    ...
    <div class="hero">
        <div class="container">
            <form action="#" class="find-location">
                ...
                <button type="submit" class="save" @click.prevent="submitSave" v-if="token">Save</button>
                <button type="submit" class="find" @click.prevent="submitFind">Find</button>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...mapActions(customStore, ["fetchPopularLocations", "fetchSearchLocation", "createSavedLocation"]),
